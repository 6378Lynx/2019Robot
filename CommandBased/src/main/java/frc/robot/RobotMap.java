...
public class RobotMap {
    ...
    public static final int pistonTwo_1 = 1;
    public static final int pistonTwo_2 = 0;
    ...
    //PCM 1
    public static final int front_1 = 4;
    public static final int front_2 = 5;
    public static final int back_1 = 0;
    public static final int back_2 = 1;
    public static final int discBrake_1 = 3;
    public static final int discBrake_2 = 2;
    ...
    public static final double armDistPerPulse = (1 / encoderPulsePerRev * gearRatio_2) * 360;
